<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TatCaHoaQua.ascx.cs" Inherits="shopbanhoa.Product.TatCaHoa" %>




    
  <!--code hiện full sản phẩm ----------------------------------------------------------------------- -->
...
<!-- code phân trang sản phẩm ------------------------------------------------------------ -->
<div class="bg_pagination">


<div class="pagination">
    <% if (PageIndex > 0) { %>
        <a href="?page=<%= PageIndex - 1 %>">Previous</a>
    <% } %>
    ...
    <% if (PageIndex < TotalPages - 1) { %>
        <a href="?page=<%= PageIndex + 1 %>">Next</a>
    <% } %>
</div>
