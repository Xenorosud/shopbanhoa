<%@ Page Title="" Language="C#" MasterPageFile="~/HomeShop.Master" AutoEventWireup="true" CodeBehind="PAGEHQMD.aspx.cs" Inherits="shopbanhoa.PageHQMD" %>

<%@ Register Src="~/Product/HQMD.ascx" TagPrefix="uc1" TagName="HoaSen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class="all-body-prs" style="margin-top:2rem;">
  ...
  <div class="body_parts">
       ...
       <uc1:HoaSen runat="server" ID="HoaSen" />
