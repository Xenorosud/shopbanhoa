<%@ Page Title="" Language="C#" MasterPageFile="~/HomeShop.Master" AutoEventWireup="true" CodeBehind="TrangLoaiHoa.aspx.cs" Inherits="shopbanhoa.TrangLoaiHoaQua" %>
<%@ Register Src="~/Product/GoiYSP.ascx" TagPrefix="uc1" TagName="GoiYSP" %>
<%@ Register Src="~/Product/TrangLoaiHoaQua.ascx" TagPrefix="uc1" TagName="TrangLoaiHoas" %>
 ...
 <select id="ddlSapXep" class="sort-ddlSortOptions">
  ...
  <div class="body_parts">
    <!-- 1 card -->  
       ...
       <uc1:TrangLoaiHoas runat="server" ID="TrangLoaiHoaQua" />
