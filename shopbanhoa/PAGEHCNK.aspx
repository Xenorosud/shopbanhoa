<%@ Page Title="" Language="C#" MasterPageFile="~/HomeShop.Master" AutoEventWireup="true" CodeBehind="PAGEHCNK.aspx.cs" Inherits="shopbanhoa.PageHCNK" %>

<%@ Register Src="~/Product/HQNK.ascx" TagPrefix="uc1" TagName="HoaHong" %>
...
<div class="all-body-prs" style="margin-top:2rem;">
    ...
    <uc1:HoaHong runat="server" id="HCNK" />
