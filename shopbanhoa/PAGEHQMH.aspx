<%@ Page Title="" Language="C#" MasterPageFile="~/HomeShop.Master" AutoEventWireup="true" CodeBehind="PAGEHQMH.aspx.cs" Inherits="shopbanhoa.PageHQMH" %>

<%@ Register Src="~/Product/HQMH.ascx" TagPrefix="uc1" TagName="HoaLy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class="all-body-prs" style="margin-top:2rem;">
  ...
  <div class="body_parts">
    ...
    <uc1:HoaLy runat="server" id="HoaLy" />
